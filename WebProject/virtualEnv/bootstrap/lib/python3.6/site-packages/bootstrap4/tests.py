...
class MediaTest(TestCase):
    ...
    def test_bootstrap_javascript_tag(self):
        ...
        self.assertInHTML(
            '<script'
            ' src="https://maxcdn.bootstrapcdn.com/bootstrap_project/4.0.0-beta.2/js/bootstrap_project.min.js"'
    ...
    def test_bootstrap_css_from_base_url(self):
        with self.settings(BOOTSTRAP4={'base_url': '//example.com/', 'css_url': None}):
            ...
            self.assertEqual(res, '//example.com/css/bootstrap_project.min.css')
            res = render_template_with_form('{% bootstrap_css %}').strip()
            self.assertInHTML(
                '<link'
                ' href="//example.com/css/bootstrap_project.min.css"'
                ' rel="stylesheet">',
                res
            )
...
class TemplateTest(TestCase):
    ...
    def test_javascript_without_jquery(self):
        ...
        self.assertIn('bootstrap_project', res)
