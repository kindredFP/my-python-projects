...
BOOTSTRAP4_DEFAULTS = {
    ...
    'css_url': {
        'href': 'https://maxcdn.bootstrapcdn.com/bootstrap_project/4.0.0-beta.2/css/bootstrap_project.min.css',
    ...
    'javascript_url': {
        'url': 'https://maxcdn.bootstrapcdn.com/bootstrap_project/4.0.0-beta.2/js/bootstrap_project.min.js',
...
def bootstrap_url(postfix):
    """
    Prefix a relative url with the bootstrap_project base url
    """
...
def javascript_url():
    ...
    return url if url else bootstrap_url('js/bootstrap_project.min.js')
...
def css_url():
    ...
    return url if url else bootstrap_url('css/bootstrap_project.min.css')
